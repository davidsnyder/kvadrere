...
2. @test/test_tile_geometry.sh@ runs the above command and combines the @part-*@ files into a single GeoJSON feature collection for display in a program like QGIS.

@test/data/admin0_MX.geojson@ contains a single GeoJSON Feature MultiPolygon for Mexico.
